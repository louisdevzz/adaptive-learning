...
interface KnowledgePointHeaderProps {
  onCreate: () => void;
}

export function KnowledgePointHeader({ onCreate }: KnowledgePointHeaderProps) {
  return (
    <div className="flex items-center justify-between w-full">
      <div className="flex flex-col gap-1">
        <h1 className="font-semibold leading-7 text-[#181d27] text-xl">
          Quản lý điểm kiến thức
        </h1>
        <p className="font-normal leading-5 text-[#535862] text-sm">
          Quản lý và theo dõi tất cả điểm kiến thức trong hệ thống
        </p>
      </div>
      <Button
        size="sm"
